...
VL_ATTR_COLD void Vsigdelay___024root___ctor_var_reset(Vsigdelay___024root* vlSelf) {
    ...
    vlSelf->sigdelay__DOT__wr_address = VL_RAND_RESET_I(9);
    vlSelf->sigdelay__DOT__rd_address = VL_RAND_RESET_I(9);
    for (int __Vi0=0; __Vi0<512; ++__Vi0) {
        vlSelf->sigdelay__DOT__ram__DOT__ram_array[__Vi0] = VL_RAND_RESET_I(8);
    }
    vlSelf->__Vdly__sigdelay__DOT__wr_address = VL_RAND_RESET_I(9);
}
